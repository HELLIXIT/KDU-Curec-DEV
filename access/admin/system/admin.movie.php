            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="admin.movie.php" method="post" enctype="multipart/form-data" id="drForm"
                              name="drForm" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label">Medical Registration ID
                                    </label>
                                </div>
                                <div class="col-12 col-md-9"><input type="text" id="medicalid" name="medicalID"
                                                                    value="<?php echo $mediID; ?>"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="nic" name="nic"
                                                                    value="<?php echo $nic; ?>"
                                                                    placeholder="123456789V" class="form-control"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="workarea" name="workArea"
                                                                    value="<?php echo $workarea; ?>"
                                                                    class="form-control" required></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                                                 class=" form-control-label">Telephone Number </label>
                                </div>
                                <div class="col-12 col-md-9"><input type="number" id="tele" name="tel"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="email" id="email"
                                                                    ...
                                                                    name="email" placeholder="abc@abc.com"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="password" id="pw"
                            ...
                            <div class="card-footer">
                                ...
                                <button type="button" name="searchbyName" id="myButton" class="btn btn-primary btn-sm"
                                        formaction='admin.movie.php' onclick="performAction('search');">
                                    <i class="fa fa-search"></i> By Name
                                </button>

                                <button type="submit" name="insertDr" class="btn btn-primary btn-sm"
                                        formaction='php/insertDr.php' onclick="anyfunction() ">
                                    <i class="fa fa-plus"></i> Add
                                </button>
                                <button type="submit" class="btn btn-primary btn-sm" name="drUpdate"
                                        onclick="anyfunction()" formaction='php/insertDr.php'>
                                    <i class="fa fa-wrench"></i> Update
                                </button>
                                <button type="submit" class="btn btn-danger btn-sm" name="drDelete"
                                        onclick="return checkDelete();" formaction='php/insertDr.php'>
